  ...
  return (
    <div className="SignUpFigmaMain">
      <div className="SignUpFigmaPart1">
        <div className="SignUpFigmaMainImage">
          <img className="SignUpFigmaImageMain" src={MainLogo} />
        </div>
        <div className="SignUpFigmaSecond">
          <div className="SignUpFigmaMainImage2">
          ...
          <div className="SignUpFigmaTexts">
            ...
            <p className="SignUpFigmaText-Para">
              ...
              learning opportunities through our simulated software development
              projects.
            </p>
          </div>
        </div>
        <div className="SignUpFigmaUnder">@ 2023 Class2Code</div>
      </div>
      <div className="SignUpFigmabox">
      ...
      <div className="SignUpFigmaPart2Second">
        ...
        <div className="SignUpFigmaLink">
          ...
          <div className="SignUpFigmaLineAll">
            <div className="SignUpFigmaOrClass">
              <span className="SignUpFigmaLineOr"></span>
              <span className="SignUpFigmaOr">or</span>
              <span className="SignUpFigmaLineOr"></span>
            </div>
          </div>
        </div>

        <div className="SignUpFigmaInputs">
