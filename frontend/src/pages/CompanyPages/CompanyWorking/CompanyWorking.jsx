...
`;
const GET_WORKING_COMPANIES_Filter = gql`
  query Query($userId: String!, $filterType: String, $desc: Boolean) {
...
`;
const SEARCH_IN_WORKING_COMPANIES = gql`
  query Query($userId: String!, $word: String!) {
