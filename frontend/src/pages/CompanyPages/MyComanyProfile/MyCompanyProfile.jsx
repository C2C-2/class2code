...
function MyCompanyProfile() {
  return (
    <div className="MyCompanyProfileAll">
        <SideBar />
      <div className="MainMyCompanyProfile">
          <NavBar />
        <div className="CenterMyCompanyProfile">
          <div className="AllMyCompanyProfile">
          <div className="MyCompanyProfileButtonBack">
            <Button
              justify="center "
              variant="filled"
              color="#283739"
          ...
          <div className="Part2Center">
          <div className="DescriptionMyCompanyProfile">
          ...
          <div className="ContentMyCompanyProfile">
            <div className="Part1MyCompanyProfile">
              ...
              <div className="InputsTextMyCompanyProfile">
              ...
              <div className="InputOverAll">
                ...
                <div className="InputOverAll">
                  <span className="TextPartCmopany">Domain</span>
                  <input
                    type="text"
                    placeholder="Domain"
                    className="TextInput"
          ...
          <Button variant="filled" color="#388E3C" w={135}h={40}>Edit Profile</Button>
          </div>
          </div>
          </div>
        </div>
