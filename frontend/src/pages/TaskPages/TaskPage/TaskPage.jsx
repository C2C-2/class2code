                ...
                <div className={`${isDarkMode ? "TaskPageContentPart2 bg-black" : "TaskPageContentPart2"}`}>
                  ...
                  {taskData.Steps.map((step, index) => (
                    <div key={index} className="TaskPagePart2TitleAll">
                      <div className="TaskPageContentPart2Title">
                        <div className="TaskPageTitle1">
                          <Checkbox defaultChecked={step.IsCompleted} color="#388E3C" radius="xl" />
                          <span className="TaskPageText1Part1">Step {step.Number}: {step.Description}</span>
                        </div>
                      </div>
                      <hr className="TaskPageLine" />
                    </div>
