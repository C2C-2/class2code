...
function NavBar() {
  ...
  useEffect(() => {
    document.getElementById("man").style.backgroundColor = receivedData === 'light' ? '#fff' : '#000';
  }, [receivedData]);

  return (
    <div className="MainNav" >
        <div className="Nav" id="man">
          <div className="TopImage">
            <img className="NavMainLogo" alt="Logo" src={MainLogo} />
            <span className="NavTextBar">Class2Code</span>
          </div>
          <div className="TopPartNavBar">
            ...
            <div className="Svg">
              ...
              <LightDarkMode sendDataToParent={receiveDataFromChild}/>
              <button className="ButtonSvg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
