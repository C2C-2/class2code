...
import "./SignUp.css";
 const SignUp = () => {
            ...
            <div className="frame-3">
              <div className="frame-4">
                <div className="frame-5">
                      <img className="SecondLogo" alt="Logo" src={MainLogo} />
                      <span className="text-3">Class2Code</span>
                    </div>

                <img className="line-2" alt="Line" src="line-2.svg" />
              </div>
              <div className="frame-6">
                <p className="p">Sign Up to Your Account</p>
            ...
            <div className="frame-7">
              <div className="frame-8">
                ...
                <div className="LinkSocial">
                      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none"  className="Around ">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5 23.4998C14.605 23.4998 17.2081 22.4701 19.1109 20.7137L15.3943 17.8282C14.3645 18.5182 13.0472 18.926 11.5 18.926C8.50474 18.926 5.96951 16.903 5.06519 14.1848H1.22314V17.1644C3.11542 20.9228 7.00451 23.4998 11.5 23.4998Z" fill="#34A853"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M5.06523 14.1851C4.83523 13.4951 4.70455 12.758 4.70455 12.0001C4.70455 11.2421 4.83523 10.5051 5.06523 9.81506V6.83552H1.22318C0.444318 8.38802 0 10.1444 0 12.0001C0 13.8557 0.444318 15.6121 1.22318 17.1646L5.06523 14.1851Z" fill="#FBBC05"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none" className="Around">
  ...
  <path d="M6.98966 19.7475V9.39322H3.54807V19.7475H6.99002H6.98966ZM5.26959 7.97977C6.46949 7.97977 7.21651 7.18469 7.21651 6.19106C7.19405 5.17479 6.46949 4.40189 5.29241 4.40189C4.11451 4.40189 3.34521 5.17479 3.34521 6.19097C3.34521 7.1846 4.09196 7.97968 5.24704 7.97968H5.26932L5.26959 7.97977ZM8.89463 19.7475H12.3359V13.9658C12.3359 13.6568 12.3584 13.3469 12.4493 13.1262C12.698 12.5076 13.2643 11.8673 14.2152 11.8673C15.4602 11.8673 15.9586 12.8168 15.9586 14.2088V19.7475H19.3998V13.8107C19.3998 10.6304 17.7022 9.15047 15.4379 9.15047C13.5816 9.15047 12.7663 10.188 12.3133 10.8947H12.3362V9.39358H8.89481C8.93973 10.3649 8.89454 19.7478 8.89454 19.7478L8.89463 19.7475Z" fill="white"/>
                ...
                <div className="frame-12">
                  <div className="frame-13">
                    ...
                    <div className="div-wrapper">
                      <div className="text-wrapper-6">Osama Ghneem</div>
                    </div>
                  </div>
                  <div className="frame-13">
                    <div className="text-wrapper-5">Username</div>
                    <div className="div-wrapper">
                      <div className="text-wrapper-6">Osama1</div>
                    </div>
                  </div>
                  <div className="frame-13">
                    <div className="text-wrapper-5">Email</div>
                    <div className="div-wrapper">
                      <div className="text-wrapper-6">mail@abc.com</div>
                    </div>
                  </div>
        ...
        <img className="Image" src={MainLogo}></img>
          <img className="element" alt="Element" src={Main} />
          <div className="frame-18">
            <div className="text-wrapper-11">Create your own company</div>
            <p className="we-re-excited-to">
              We&#39;re excited to welcome you to the Class2Code community! By creating an account, you&#39;ll gain
              access to a wealth of learning opportunities through our simulated software development projects.
            </p>
          </div>
          <div className="text-wrapper">@ 2023 Class2Code</div>
        </div> 
