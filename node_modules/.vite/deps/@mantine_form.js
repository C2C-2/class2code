...
function useForm({
  ...
  const getInputProps = (path, { type = "input", withError = true, withFocus = true, ...otherOptions } = {}) => {
    ...
    if (mode === "uncontrolled") {
      payload.key = `${formKey}-${path}-${fieldKeys[path] || 0}`;
    }
    if (withError) {
...
function createFormContext() {
  ...
  function FormProvider({ form, children }) {
    return import_react8.default.createElement(FormContext.Provider, { value: form }, children);
  }
...
var Form = (0, import_react9.forwardRef)(
  ({ form, onSubmit, onReset, ...others }, ref) => import_react9.default.createElement(
    "form",
    {
      ...others,
